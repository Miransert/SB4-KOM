...
import dk.sdu.student.miser21.common.util.SPILocator;
import dk.sdu.student.miser21.components.IProcessor;
import dk.sdu.student.miser21.components.PluginInjection;
import dk.sdu.student.miser21.managers.GameInputProcessor;
...
public class Game
    ...
    public Game() {
        ...
        this.components.scan("dk.sdu.student.miser21.components");
    ...
    public void create() {
        ...
        if (gameData.getDisplayWidth() != Gdx.graphics.getWidth()
